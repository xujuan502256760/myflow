...
$.extend(true,myflow.config.tools.states,{
	start : {
			...
			'end-cancel' : {showType: 'image',type : 'end-cancel',
				...
				text : {text:'取消'},
				img : {src : 'images/48/end_event_cancel.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			'end-error' : {showType: 'image',type : 'end-error',
				name : {text:'<<end-error>>'},
				text : {text:'错误'},
				img : {src : 'images/48/end_event_error.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			fork : {showType: 'image',type : 'fork',
				...
				props : {
					...
					temp1: {name:'temp1', label: '文本', value:'', editor: function(){return new myflow.editors.inputEditor();}},
					temp2: {name:'temp2', label : '选择', value:'', editor: function(){return new myflow.editors.selectEditor([]);}}
				}},
			...
			task : {
				...
				img : {src : 'images/48/task_empty.png',width :48, height:48},
				props : {
					id:{name:'id', label: 'ID', value:'',isShow:true},
					text: {name:'text', label: '显示', value:'', editor: function(){return new myflow.editors.textEditor();}},
					nameCh: {name:'nameCh', label: '中文名字',value:'', editor: function(){return new myflow.editors.inputEditor();}},
					descr: {name:'descr', label : '描述', value:'', editor: function(){return new myflow.editors.inputEditor();}},
					rule: {name:'rule', label: '选择规则', value:'', editor: function(){return new myflow.editors.buttonEditor('请选择');}},
					ruleId: {name:'ruleId', label: '选择的规则ID', value:'', editor: function(){return new myflow.editors.inputEditor();}},
				}}
});
})(jQuery);
